...
const fields: Field[] = [
  ...
  { name: "tecnicoLocal", type: "select", labelPT: "Técnico está no local?", labelES: "El técnico está en el sitio?", options:["Sim","Não","Balcão"] },
  ...
  { name: "fluxoDtc", type: "text", labelPT: "Fluxo Seguido no DTC", labelES: "Flujo seguido en DTC", hasNao:true },
